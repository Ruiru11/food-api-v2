...
def signup():
    ...
    parser.add_argument('address',type=str, required=True, help="Pease provide an address", location="json")
    parser.add_argument('password',type=str,required=True, help="Pease provide a password",location="json")
    parser.add_argument('username',type=str, required=True, help="Pease provide username",location="json")
